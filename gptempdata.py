...
def gaus(x, A1, mu1, sigma1, A2, mu2, sigma2):
...
p0 = [1, 90, 15 ,
      0.12, 35, 2]
coeff, cov = curve_fit(gaus,x_observed,T_observed_mean,p0=p0)
T_fit = gaus(x_observed,*coeff)
...
T_expected_fit = gaus(x_observed, *coeff) #coeff)     #expected y values with double-gaussian-fit
